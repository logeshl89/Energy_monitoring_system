...
def train_model(train_loader, test_loader, num_epochs=30, learning_rate=0.001):
...
def main():
    ...
    model = train_model(train_loader, test_loader, num_epochs=20, learning_rate=0.001)
